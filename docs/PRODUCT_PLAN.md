...
Tamil Stoic will use Project Madurai for the Tamil source layer, preserving its header, attribution, source URL, and any distribution conditions. The English layer will be a separate Tamil Stoic translation programme: it will not be labelled as a Project Madurai translation or as Project Madurai-owned. Each translation will record its translator, licence, whether AI assistance was used, and the named human Tamil and English proofreaders. AI may assist with a draft or consistency checks, but human reviewers approve meaning, cultural context, register, and publication. Existing English translations found inside Project Madurai files are a separate rights case: some identify an individual translator and impose additional conditions, so they must not be copied into the Tamil Stoic corpus without permission. Contact the Project Madurai coordinators before bulk online distribution.
